...
│   ├── src/translators/ # What a container says about the bytes inside it (ZIP, TAR, RAR, ISO)
│   └── src/archives/ # What still extracts: 7Z alone (always on)
