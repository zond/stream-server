...
//! bytes belong to nobody. They sit beside the store
...
///
/// Dot-prefixed, like the proxy cache's `.proxy` beside it, so that a
/// torrent named `pieces` cannot land on top of it.
///
